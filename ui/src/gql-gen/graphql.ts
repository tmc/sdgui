...
export type SubscriptionSubscription = { __typename?: 'Subscription', observeProgram: { __typename?: 'Program', id: string, description: string, files?: Array<{ __typename?: 'File', path: string, rationale: string, generationStatus: GenerationStatus, content: string }> | null, sharedDependencies?: Array<{ __typename?: 'Dependency', name: string, description: string, symbols: Array<{ __typename?: 'SymbolMap', key: string, value: string }> }> | null } };
